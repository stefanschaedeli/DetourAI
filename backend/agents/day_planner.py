    ...
    async def _plan_single_day(self, day_ctx: dict) -> dict:
        ...
        _L = {
            "de": {
                ...
                "desc_day": "4-6 Sätze, die den Charakter des Tages einfangen: Highlights, Atmosphäre, besondere Momente",
                "block_desc": "2-3 Sätze mit konkreten Details zu diesem Erlebnis oder dieser Aktivität",
                ...
                "adapt": "Passe die time_blocks realistisch an den Tag an. activity_type kann sein: drive, activity, meal, break, check_in. Schreibe für jeden time_block eine lebendige description mit 2-3 Sätzen, die konkrete Details und Atmosphäre vermitteln.",
            ...
            "en": {
                ...
                "desc_day": "4-6 sentences capturing the character of the day: highlights, atmosphere, special moments",
                "block_desc": "2-3 sentences with concrete details about this experience or activity",
                "departure_to": "Departure to",
                "road": "Highway / Main road",
                "drive_from": "Drive from {prev} to {region}",
                "lunch": "Lunch",
                "local_cuisine": "Enjoy local cuisine",
                "adapt": "Adapt the time_blocks realistically to the day. activity_type can be: drive, activity, meal, break, check_in. Write a vivid description of 2-3 sentences for each time_block, conveying concrete details and atmosphere.",
            ...
            "hi": {
                ...
                "desc_day": "दिन के चरित्र को दर्शाने वाले 4-6 वाक्य: हाइलाइट्स, माहौल, विशेष क्षण",
                "block_desc": "इस अनुभव या गतिविधि के बारे में ठोस विवरण के साथ 2-3 वाक्य",
                ...
                "adapt": "time_blocks को दिन के अनुसार यथार्थवादी रूप से अनुकूलित करें। activity_type हो सकता है: drive, activity, meal, break, check_in। प्रत्येक time_block के लिए 2-3 वाक्यों का जीवंत विवरण लिखें जो ठोस विवरण और माहौल को व्यक्त करे।",
