    ...
    async def find_options(self, stop: dict, budget_per_night: float,
        ...
        _L = {
            "de": {
                ...
                "rule6": "Beschreibung: 2-3 Absätze mit Zimmerausstattung, Lage und Umgebung, Dining-Optionen und was diese Unterkunft besonders macht.",
            ...
            "en": {
                ...
                "rule6": "Description: 2-3 paragraphs covering room amenities, location and surroundings, dining options, and what makes this accommodation especially worth choosing.",
            ...
            "hi": {
                ...
                "rule6": "विवरण: कमरे की सुविधाओं, स्थान और परिवेश, डाइनिंग विकल्पों और इस आवास को विशेष रूप से चुनने योग्य क्या बनाता है — 2-3 पैराग्राफ।",
